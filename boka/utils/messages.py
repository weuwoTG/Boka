...
async def answer(
    ...
    **kwargs,
    ...
    :param message: Message to answer to. Can be a tl message or boka inline object
    ...
    parse_mode = boka_tl.utils.sanitize_parse_mode(
        kwargs.pop(
            "parse_mode",
    ...
    if isinstance(response, str) and not kwargs.pop("asfile", False):
        ...
        if len(text) >= 4096 and not hasattr(message, "boka_grepped"):
            try:
