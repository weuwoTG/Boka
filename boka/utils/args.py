...
import boka_tl
import boka_tl.extensions
import boka_tl.extensions.html
...
def validate_html(html: str) -> str:
    ...
    :return: Valid HTML
    """
    text, entities = boka_tl.extensions.html.parse(html)
    return boka_tl.extensions.html.unparse(escape_html(text), entities)
