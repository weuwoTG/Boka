...
def restart():
    ...
    if "BOKA_DO_NOT_RESTART2" in os.environ:
        print("Restart loop detected, forcing shutdown. boka_tl is bundled with Boka.")
        sys.exit(0)
    ...
    if "BOKA_DO_NOT_RESTART" not in os.environ:
        os.environ["BOKA_DO_NOT_RESTART"] = "1"
    else:
        os.environ["BOKA_DO_NOT_RESTART2"] = "1"
