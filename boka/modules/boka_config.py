...
from boka_tl.extensions import html
...
class _InlineFormDraft:
    ...
    def __init__(self):
        ...
        self.reply_markup: BokaReplyMarkup | None = None
...
@loader.tds
class BokaConfigMod(loader.Module):
    """Interactive configurator for Boka Userbot"""

    strings = {"name": "BokaConfig"}
    ...
    def _category_option(
        ...
        if option in BokaConfigMod._config_categories(instance).get(category, []):
            return option
