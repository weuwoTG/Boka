...
import boka_tl
from boka_tl.errors.rpcerrorlist import MessageIdInvalidError
from boka_tl.sessions import StringSession
from boka_tl.tl.types import Message
from meval import meval

from .. import loader, main, utils
from ..log import BokaException
...
class Evaluator(loader.Module):
    ...
    class _SecureDB:
        ...
        def set(self, *args, **kwargs):
            if len(args) >= 2 and args[0] == "boka.security" and args[1] == "owner":
                raise ValueError(
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = BokaException.from_exc_info(*sys.exc_info())
            print_output = output_print.getvalue()
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.boka_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("boka.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "self": self,
            "db": self.db,
            **self.get_sub(boka_tl.tl.functions),
            **self.get_sub(boka_tl.tl.types),
        }
