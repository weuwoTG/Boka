...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    async def respond(self, *args, **kwargs):
        ...
        """
        if self._client:
            if 'reply_to' not in kwargs and self.reply_to and self.reply_to.forum_topic:
                kwargs['reply_to'] = self.reply_to.reply_to_top_id or self.reply_to.reply_to_msg_id
